...
<div className='w-full flex justify-around items-center'>
    <p className='text-right px-3 text-nowrap font-bold text-xl font-mono '>مواقف أكادمية طويق</p>
...
<div className="card w-full  bg-neutral mt-4 h-12 justify-center rounded-none text-primary-content items-center">
        ...
        <p className='font-bold text-xl font-mono p-2'>ارسال التذكرة اللى الايميل؟</p>
      ...
      <input className='btn btn-primary w-52 font-semibold text-xl' type="submit" value="ارسال" />
    </form>
    </div>
  )
}
